export default [
  ...
  // *===============================================---*
  {
    path: '/apps/kategori',
    name: 'apps-kategori',
    component: () => import('@/views/apps/kategori/Main.vue'),
    meta: {
  ...
  // *===============================================---*
  {
    path: '/apps/service',
    name: 'apps-service',
    component: () => import('@/views/apps/service/Main.vue'),
    meta: {
      // contentRenderer: 'sidebar-left',
      // contentClass: 'email-application',
    },
  ...
  // *===============================================---*
  {
    path: '/apps/influence',
    name: 'apps-influence',
    component: () => import('@/views/apps/influence/Main.vue'),
    meta: {
      // contentRenderer: 'sidebar-left',
      // contentClass: 'email-application',
    },
  ...
  {
    path: '/apps/influence/create',
    name: 'influence-create',
    component: () => import('@/views/apps/influence/store/AccountSetting.vue'),
    meta: {
      // contentRenderer: 'sidebar-left',
      // contentClass: 'email-application',
    },
